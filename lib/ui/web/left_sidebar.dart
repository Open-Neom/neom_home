            ...
            child: ListView(
              ...
              children: [
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Icon(FontAwesomeIcons.om as IconData,
                ...
                if (AppFlavour.showGames())
                  _NavItem(
                    icon: FontAwesomeIcons.gamepad as IconData,
                ...
                if (AppFlavour.showBlog())
                  _NavItem(
                    icon: FontAwesomeIcons.filePen as IconData,
                ...
                if (AppFlavour.showVst() && AppGates.canUseHiddenBeta())
                  _NavItem(
                    icon: FontAwesomeIcons.guitar as IconData,
                ...
                if (AppFlavour.showDaw() && AppGates.canUseHiddenBeta())
                  _NavItem(
                    icon: FontAwesomeIcons.sliders as IconData,
                ...
                // Notifications
                _NavItem(
                  icon: FontAwesomeIcons.bell as IconData,
                ...
                _NavItem(
                  icon: FontAwesomeIcons.comments as IconData,
                ...
                if (_isCreatorOrSupport) ...[
                  ...
                  if (AppFlavour.showNupale())
                    _NavItem(
                      icon: FontAwesomeIcons.bookOpenReader as IconData,
                  ...
                  if (AppFlavour.showCasete())
                    _NavItem(
                      icon: FontAwesomeIcons.solidFileAudio as IconData,
                  ...
                  if (AppFlavour.showWallet())
                    _NavItem(
                      icon: FontAwesomeIcons.coins as IconData,
