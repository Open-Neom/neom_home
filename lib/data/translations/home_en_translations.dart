...
class HomeEnTranslations {
  ...
  static const Map<String, String> values = {
    ...
    HomeTranslationConstants.seeAll: 'See all',
    HomeTranslationConstants.follow: 'Follow',
    HomeTranslationConstants.newReleases: 'New Releases',
    HomeTranslationConstants.featuredBooks: 'Featured Books',
    ...
    HomeTranslationConstants.navDirectory: 'Directory',
    HomeTranslationConstants.navBooking: 'Booking',
    ...
    HomeTranslationConstants.navCollectives: 'Collectives',
    ...
    HomeTranslationConstants.navUploadWork: 'Upload Work',
