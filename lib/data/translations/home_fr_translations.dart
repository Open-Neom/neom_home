...
class HomeFrTranslations {

  static const Map<String, String> values = {
    HomeTranslationConstants.shareWriting: 'Partager un écrit',
    HomeTranslationConstants.shareWritingMsg: 'Exprimez votre essence à la communauté et partagez l\'un de vos écrits pour inspirer les autres.',

    // Web sidebar & sections
    HomeTranslationConstants.suggestionsForYou: 'Suggestions pour vous',
    HomeTranslationConstants.seeAll: 'Voir tout',
    HomeTranslationConstants.follow: 'Suivre',
    ...
    HomeTranslationConstants.navLevitation: 'Lévitation',
    HomeTranslationConstants.navInter: 'Interface',
    HomeTranslationConstants.navBooks: 'Livres',
    HomeTranslationConstants.navDirectory: 'Repertoire',
    HomeTranslationConstants.navBooking: 'Reservations',
    ...
    HomeTranslationConstants.navCollectives: 'Collectifs',
    ...
    HomeTranslationConstants.navUploadWork: 'Téléverser Oeuvre',
    ...
    HomeTranslationConstants.dawStudioCardTitle: "Studio d'Enregistrement",
    HomeTranslationConstants.dawStudioCardSubtitle: 'Ouvre la DAW pour créer, mixer et publier tes pistes.',
    HomeTranslationConstants.dawStudioCardBadge: 'DAW Intégrée',
  };
